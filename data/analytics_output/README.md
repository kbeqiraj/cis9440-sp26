...
March 2021 records only 14 complaints, and April 2021 through January 2022 is missing entirely.
...
is 25, which makes any per-capita rate meaningless, so the view applies a population threshold
that removes it.
