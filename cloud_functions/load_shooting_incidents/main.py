...
SOCRATA_DATASET_ID = '5ucz-vwe8'  # NYC Shootings (2006-Present)
CHUNK_SIZE = 5000
ORDER_BY_FIELD = 'occur_date'  # Primary date field for this dataset
...
BQ_TABLE_ID = 'nyc_shooting_incidents'

# Initialize BigQuery Client
bq_client = bigquery.Client(project=BQ_PROJECT_ID)


# Schema matches the Shootings dataset columns (all lowercase per clean_record())
CORE_BQ_SCHEMA = [
    SchemaField("incident_key",       "INTEGER",   mode="REQUIRED", description="Randomly generated persistent ID for each incident"),
    SchemaField("occur_date",         "TIMESTAMP", description="Exact date of the shooting incident"),
    SchemaField("occur_time",         "STRING",    description="Exact time of the shooting incident"),
    SchemaField("boro",               "STRING",    description="Borough where the shooting incident occurred"),
    SchemaField("loc_of_occur_desc",  "STRING",    description="Flag indicating where incident occurred"),
    SchemaField("precinct",           "INTEGER",   description="Precinct where the shooting incident occurred"),
    SchemaField("jurisdiction_code",  "INTEGER",   description="Jurisdiction where the shooting incident occurred (0=Patrol, 1=Transit, 2=Housing)"),
    SchemaField("loc_classfctn_desc", "STRING",    description="Category describing type of location"),
    SchemaField("location_desc",      "STRING",    description="Category for specific type of location of the shooting incident"),
    SchemaField("x_coord_cd",         "INTEGER",   description="Midblock X-coordinate, NY State Plane, NAD 83, feet (FIPS 3104)"),
    SchemaField("y_coord_cd",         "INTEGER",   description="Midblock Y-coordinate, NY State Plane, NAD 83, feet (FIPS 3104)"),
    SchemaField("latitude",           "FLOAT",     description="Midblock Latitude, WGS 1984 (EPSG 4326)"),
    SchemaField("longitude",          "FLOAT",     description="Midblock Longitude, WGS 1984 (EPSG 4326)"),
]
